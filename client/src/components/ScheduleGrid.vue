...
const props = defineProps<{
  ...
  ackMap?: Record<number, { acknowledged: number; total: number; percentage: number }>
}>()
            ...
            <div
              ...
              :class="[
                ...
                props.highlightUserId && entry.user_id === props.highlightUserId
                  ...
                  : props.ackMap && entry.user_id in props.ackMap && props.ackMap[entry.user_id]?.percentage < 100
                    ? 'bg-white/[0.03] ring-1 ring-red-500/60'
                    : 'bg-white/[0.03]',
              ]"
              :title="props.ackMap && entry.user_id in props.ackMap && props.ackMap[entry.user_id]?.percentage < 100
