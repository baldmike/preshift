            ...
            <div class="space-y-2">
              ...
              <div class="flex gap-2 justify-end">
                <button
                  type="button"
                  @click="resetEdit"
                  class="px-3 py-2 text-xs font-semibold text-gray-400 hover:text-gray-300 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  @click="saveEdit"
                  :disabled="saving"
                  class="px-3 py-2 text-xs font-semibold rounded bg-white/[0.08] text-gray-200 hover:bg-white/[0.12] transition-colors disabled:opacity-40"
                >
                  {{ saving ? 'Saving...' : 'Save' }}
                </button>
              </div>
              ...
              <div class="flex items-center gap-1.5 shrink-0">
                ...
                <template v-if="canEdit">
                  <button
                    ...
                    class="p-2 -m-2 text-gray-500 hover:text-gray-300 transition-colors"
                  >
                  ...
                  <button
                    ...
                    class="p-2 -m-2 text-gray-500 hover:text-red-400 transition-colors"
                  >
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
