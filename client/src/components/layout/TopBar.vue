      ...
      <div class="flex items-center justify-between">
        ...
        <div class="min-w-0 flex-1">
          <h1 class="text-sm sm:text-xl font-bold tracking-tight truncate">
            <template v-if="establishment !== 'PreShift86'">{{ establishment }}</template>
            <template v-else><span class="text-green-400">Pre</span><span class="text-yellow-400">Shift</span><span class="text-red-400">86</span></template>
          </h1>
