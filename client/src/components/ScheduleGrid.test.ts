  ...
  entries: [
    {
      ...
      role: 'server',
      notes: null,
      user: { id: 3, location_id: 1, name: 'Jake', email: 'j@test.com', role: 'server', roles: null, is_superadmin: false, phone: null, availability: null, created_at: '', updated_at: '' },
    ...
    },
    {
      ...
      role: 'bartender',
      notes: null,
      user: { id: 4, location_id: 1, name: 'Mia', email: 'm@test.com', role: 'bartender', roles: null, is_superadmin: false, phone: null, availability: null, created_at: '', updated_at: '' },
