  ...
  entries: [
    {
      ...
      role: 'server',
      notes: null,
      user: { id: 3, location_id: 1, name: 'Jake', email: 'j@test.com', role: 'server', phone: null, availability: null, created_at: '', updated_at: '' },
    ...
    },
    {
      ...
      role: 'bartender',
      notes: null,
      user: { id: 4, location_id: 1, name: 'Mia', email: 'm@test.com', role: 'bartender', phone: null, availability: null, created_at: '', updated_at: '' },
