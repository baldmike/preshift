  ...
  it('renders grouped shift entries with staff names and role badges', async () => {
    ...
    store.currentSchedule = makeSchedule([
      makeEntry({
        ...
        user_id: 1,
        role: 'server',
        user: { id: 1, name: 'Alice', email: 'a@t.com', role: 'server', location_id: 1, is_superadmin: false, phone: null, availability: null, created_at: '', updated_at: '' },
      ...
      makeEntry({
        ...
        user_id: 2,
        role: 'bartender',
        user: { id: 2, name: 'Bob', email: 'b@t.com', role: 'bartender', location_id: 1, is_superadmin: false, phone: null, availability: null, created_at: '', updated_at: '' },
        shift_template: { id: 10, location_id: 1, name: 'Dinner', start_time: '16:00', created_at: '', updated_at: '' },
      }),
    ])
